...
allItems.emplace_back("Violin", ItemColor::Yellow, 3, "Camp", "../Assets/Items/Yellow/Violin.png");
allItems.emplace_back("Scroll of Thoth", ItemColor::Yellow, 4, "Museum", "../Assets/Items/Yellow/Scroll.png");
allItems.emplace_back("Scroll of Thoth", ItemColor::Yellow, 4, "Museum", "../Assets/Items/Yellow/Scroll.png");

// Blue items
allItems.emplace_back("Anatomy Text", ItemColor::Blue, 1, "Institute", "../Assets/Items/Blue/AnatomyText.png");
allItems.emplace_back("Anatomy Text", ItemColor::Blue, 1, "Institute", "../Assets/Items/Blue/AnatomyText.png");
allItems.emplace_back("Centrifuge", ItemColor::Blue, 1, "Laboratory", "../Assets/Items/Blue/Centrifuge.png");
allItems.emplace_back("Centrifuge", ItemColor::Blue, 1, "Laboratory", "../Assets/Items/Blue/Centrifuge.png");
...
allItems.emplace_back("Analysis", ItemColor::Blue, 2, "Institute", "../Assets/Items/Blue/Analysis.png");
allItems.emplace_back("Experiment", ItemColor::Blue, 2, "Laboratory", "../Assets/Items/Blue/Experiments.png");
allItems.emplace_back("Experiment", ItemColor::Blue, 2, "Laboratory", "../Assets/Items/Blue/Experiments.png");
